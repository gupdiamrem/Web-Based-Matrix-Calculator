...
document.getElementById('matrixAdditionForm').addEventListener('submit', function(e) {
    ...
    try {
        ...
        const result = calculateAddition(matrixA, matrixB);
...
function calculateAddition(mat1, mat2) {
